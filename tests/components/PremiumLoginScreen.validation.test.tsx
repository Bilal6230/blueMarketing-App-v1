...
describe('PremiumLoginScreen validation errors', () => {
  ...
  it('shows backend email and password field validation messages', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('The password field is required.')).toBeTruthy();
    });
  });
});
