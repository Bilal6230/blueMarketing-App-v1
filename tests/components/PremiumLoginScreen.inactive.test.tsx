...
describe('PremiumLoginScreen inactive account', () => {
  ...
  it('shows "Your account is inactive." for inactive or forbidden responses', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Your account is inactive.')).toBeTruthy();
    });
  });
});
